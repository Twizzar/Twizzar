...
{
    /// <inheritdoc cref="IViCtorToken" />
    public class ViCtorToken : ViToken, IViCtorToken
    {
        #region ctors

        /// <summary>
        /// Initializes a new instance of the <see cref="ViCtorToken"/> class.
        /// </summary>
        /// <param name="start">The start index.</param>
        /// <param name="length">The length of the token.</param>
        /// <param name="containingText">The containing text.</param>
        public ViCtorToken(int start, int length, string containingText)
