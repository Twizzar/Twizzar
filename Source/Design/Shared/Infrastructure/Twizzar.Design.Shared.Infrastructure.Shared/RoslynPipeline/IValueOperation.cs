...
{
    /// <summary>
    /// An generic operation for a single value and for a pipeline style usage.
    /// </summary>
    /// <typeparam name="TSource"></typeparam>
    public interface IValueOperation<out TSource>
    {
        /// <summary>
        ...
        /// <returns>.</returns>
        IValueOperation<TSource> WithComparer(IEqualityComparer<TSource> comparer);
    }
}